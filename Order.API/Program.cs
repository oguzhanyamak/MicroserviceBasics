...
builder.Services.AddDbContext<OrderAPIDbContext>(options => { options.UseNpgsql(builder.Configuration.GetConnectionString("Postgres")); });
builder.Services.AddMassTransit(configurator =>
{
    ...
    configurator.UsingRabbitMq((context,_configurator) =>
    {
        ...
        _configurator.ReceiveEndpoint(RabbitMQSettings.Order_PaymentSuccessEventQueue, e => e.ConfigureConsumer<PaymentCompletedEventConsumer>(context));
